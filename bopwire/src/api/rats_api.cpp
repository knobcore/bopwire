...
constexpr const char* MC_REQUEST_TYPE = "bopwire.request";
constexpr const char* MC_REPLY_TYPE   = "bopwire.reply";
...
void RatsApi::handle_request(const std::string& peer_id,
    ...
    try {
        ...
        //       (bopwire.library broadcast), which is how an edit clones
        ...
        // separate `bopwire.mod` messages. The reply just acknowledges
