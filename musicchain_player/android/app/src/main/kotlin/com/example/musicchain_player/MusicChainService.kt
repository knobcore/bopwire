 ...
 */
class MusicChainService : Service() {
    ...
    companion object {
        private const val CHANNEL_ID = "musicchain_swarm_link"
        private const val NOTIF_ID   = 1001

        /** Idempotent — calling start when already started is a no-op. */
        fun start(ctx: Context) {
            val intent = Intent(ctx, MusicChainService::class.java)
